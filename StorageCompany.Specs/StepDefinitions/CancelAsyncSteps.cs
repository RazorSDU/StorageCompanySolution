...
public class CancelAsyncSteps
{
    ...
    private Reservation GetReservation() => _reservations.First(r => r.Id == reservationId);
    private StorageUnit GetStorageUnit() => _storageUnits.First(u => u.Id == storageUnitId);
}
